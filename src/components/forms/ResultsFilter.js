        ...
        return (
            <div>
                ...
                <div className="row serch-filter__row">
                    ...
                    <div className="col s4">
                        <Range min="0" max="120" defaultValue="120" name="ibu_lt" handleChange={this.handleValue} />
                    </div>
                </div>
                ...
                <div className="row serch-filter__row">
                    ...
                    <div className="col s4">
                        <Range min="4" max="80" defaultValue="80" name="ebc_lt" handleChange={this.handleValue} />
                    </div>
                </div>
            </div>
        );
